...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.user_slug'
        db.add_column('userprofile_userprofile', 'user_slug', self.gf('django.db.models.fields.SlugField')(default='1', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.user_slug'
        db.delete_column('userprofile_userprofile', 'user_slug')
