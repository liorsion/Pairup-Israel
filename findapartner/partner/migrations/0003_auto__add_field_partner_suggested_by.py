...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Partner.suggested_by'
        db.add_column('partner_partner', 'suggested_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Partner.suggested_by'
        db.delete_column('partner_partner', 'suggested_by_id')
